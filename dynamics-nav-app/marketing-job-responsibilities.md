...
## <a name="define-a-job-responsibility-code"></a>Defina un código de responsabilidad cargo
...
1. En la esquina superior derecha, seleccione el icono **Buscar página o informe**, escriba **Responsabilidades cargo** y, a continuación, seleccione el enlace relacionado.
...
## <a name="assign-job-responsibilities-to-a-contact-person"></a>Para asignar responsabilidades cargo a personas de contacto:
...
El número de responsabilidades cargo que ha asignado al contacto se muestra en el campo **N.º responsabilidades cargo** en la sección **Segmentación** de la ventana **Contacto**.
