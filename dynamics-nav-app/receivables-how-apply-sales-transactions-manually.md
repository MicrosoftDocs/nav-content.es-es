...
Cuando cobra de un cliente o efectúa un reembolso en efectivo, debe decidir si va a liquidar el pago o a reembolsarlo a uno o varios movimientos de crédito o débito pendientes. Puede especificar el importe exacto que desea liquidar. Por ejemplo, es posible que solo desee liquidar parte del pago, y así, liquidar solo parcialmente movimientos de cliente. En algún momento, es importante cerrar (liquidar) todos los movimientos de cliente para obtener estadísticas y copias impresas correctas de los extractos de cuentas y la configuración de los documentos de interés de los clientes.

Puede liquidar movimientos de cliente de tres formas distintas:

- Introduciendo información en ventanas específicas, como la de **Diario de recibos de efectivo** y la de **Diario de conciliación de pagos**.
...
**Nota**: Si el campo **Método liquidación** de la ficha del cliente contiene **Liq. por antigüedad**, los pagos se liquidarán manualmente en el movimiento de crédito pendiente más antiguo si no especifica manualmente qué movimiento quiere liquidar. Si el método de liquidación para un cliente es **Manual**, entonces deberá liquidar los movimientos manualmente.
...
1. En la esquina superior derecha, seleccione el icono **Buscar página o informe**, escriba **Diario de recibos de efectivo** y, a continuación, seleccione el enlace relacionado.
...
1. En la esquina superior derecha, seleccione el icono **Buscar página o informe**, escriba **Diario de recibos de efectivo** y seleccione el enlace relacionado.
2. En la primera línea de diario, escriba la información correspondiente sobre el movimiento que se va a liquidar.
...
8. En el campo **Importe a liquidar**, introduzca el importe con el que desea liquidar el movimiento. Si no especifica ninguna cantidad, se usa el importe máximo.
...
9. Elija el botón **Aceptar**. La ventana **Diario de recibos de efectivo** ahora muestra el movimiento que ha introducido en **Liq. por tipo documento** y **Liq. por n.º documento**. .
10. Registro el diario de cobros.
...
9. En cada línea del campo **Importe a liquidar**, introduzca el importe con el que desea liquidar cada movimiento. Si no especifica ninguna cantidad, se usa el importe máximo.
...
**Nota**: Después de haber seleccionado un movimiento en la ventana **Liquidar movs. cliente** o varios movimientos estableciendo la **Liq. por id.**, el campo **Importe liquidado** de la línea de diario contendrá la suma de los importes restantes de los movimientos registrados que haya seleccionado, a menos que el campo ya contenga algún valor. Si selecciona **Liq. por antigüedad** en el campo **Método de liquidación** de la ficha de cliente, la liquidación se realizará automáticamente.
