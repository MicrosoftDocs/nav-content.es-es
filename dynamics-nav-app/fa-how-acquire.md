...
Tanto el activo principal como todos sus componentes deben configurarse como fichas individuales de activos. Después de configurar una lista de componentes, Dynamics NAV rellena automáticamente los campos **Principal/Componente** y **Componentes de activo principal** de las fichas de activos fijos.
...
**Sugerencia**: Si rellena el campo **N. º seguro** del diario general de activos en el momento de registrar un coste, Dynamics NAV también registrará el coste del activo en los movimientos de seguros. Para obtener más información, vea [Procedimiento: Asegurar activos fijos](fa-how-insure.md).
