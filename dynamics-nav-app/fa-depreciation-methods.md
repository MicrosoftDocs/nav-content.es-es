...
- Manual  
    ...
    Cuando utilice el método manual, debe introducir la amortización de forma manual en el diario general de activos. El proceso **Calcular amortización** ignora los activos que utilizan el método de amortización manual. Puede utilizar este método para activos no sujetos a amortización, por ejemplo, los terrenos.  
- Convenio de medio año  

    Al utilizar este método, se amortiza la misma cantidad de un activo cada año.  
...
Este cálculo garantiza que el activo se amortiza por completo al llegar la fecha final de amortización.    
...
Un activo tiene un coste de 100.000 DL. Su vida estimada es de ocho años.  

 El proceso **Calcular amortización** se realiza cada dos años. El movimiento de activos es el siguiente:  
...
Este es un método de amortización acelerado que coloca la mayor parte del coste de un activo en los primeros años de su vida útil. Si utiliza este método, deberá introducir un porcentaje fijo anual.  
...
El programa puede manipular cálculos regresivos con varios porcentajes.  
...
Al aplicar el Convenio medio año, un activo tendrá seis meses de amortización en el primer ejercicio, independientemente del contenido del campo **Fecha primera amortización**.  
