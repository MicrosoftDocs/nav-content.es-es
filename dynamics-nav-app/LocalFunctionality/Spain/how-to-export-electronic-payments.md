...
3.  En la pestaña **Inicio** del grupo **Proceso**, elija **Exportar a archivo**.  
...
5.  Seleccione **Imprimir** o **Vista previa** para ver el archivo de pagos creado.  
...
5.  Seleccione **Imprimir** o **Vista previa** para ver el archivo de pagos creado.  
    ...
    > [!NOTE]  
    >  En la versión genérica de ADD INCLUDE<!--[!INCLUDE[dyn_nav](../../includes/make-payments-with-bank-data-conversion-service-or-sepa-credit-transfer.md).  
...
## <a name="see-also"></a>Consulte también  
 ...
 [Realizar pagos con Servicio de conversión de datos del banco o Transferencia de crédito SEPA](make-payments-with-bank-data-conversion-service-or-sepa-credit-transfer.md)
