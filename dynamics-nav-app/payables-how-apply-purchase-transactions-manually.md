...
1. En la esquina superior derecha, seleccione el icono **Buscar página o informe**, escriba **Abono de compra** y, a continuación, elija el enlace relacionado.
...
7. O para liquidar múltiples movimientos de proveedor:
8. Seleccione la acción **Liquidar movs.**.
9. Seleccione las líneas que contienen los movimientos para liquidar el abono.
10. Seleccione la acción **Marcar id. de liquidación**.  
11. En cada línea del campo **Importe pendiente de liquidar**, introduzca el importe para liquidar cada movimiento.
...
13. Seleccione el botón **Registrar** para crear el abono de compra.
