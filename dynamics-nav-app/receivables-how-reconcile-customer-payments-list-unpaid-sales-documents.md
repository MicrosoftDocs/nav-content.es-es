...
3. Rellene los campos restantes de la línea de diario general, como el importe y el número del cliente u otra información del extracto de banco. Para obtener más información sobre cómo trabajar con el formulario, consulte [Trabajar con diarios generales](ui-work-general-journals.md).
