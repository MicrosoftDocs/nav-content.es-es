...
7. Seleccione una línea que corresponda a un pedido de servicio o una oferta de servicio y seleccione la acción **Mostrar documento**.  
    ...
    Se abrirá la página **Pedido de servicio** u **Oferta servicio** y podrá trabajar con el documento. Para volver a la página **Panel de distribución**, elija el botón **Aceptar**.
